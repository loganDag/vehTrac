...
$drive_db_id = $Info["ran_id"];
  ...
  echo "Please <a href='mailto:support@nexgenit.digital?subject=SQL Drive Editting Issue.'>Email Support Here</a></div>";
...
if ($Update == TRUE){
  header('refresh:0; url=drive.php?s=1');
      ...
      <form action="" method="post">
            ...
            <div class='form-floating'>
              ...
              <p class='text-muted fs-6'>Conversion clock by <a href='https://www.timecalculator.net/'>timecalculator.net</a></p>
                <input type='datetime-local' class='form-control' id='time_update' name='time_update'>
                </div>
                  </div>
                  <div class="col-5">
        ...
        <div class="modal-footer">
          <p class="text-secondary fs-5">Only update what you want to change, leave the other values as they are or they will be blank in the database</p>
          <p class="text-secondary fs-5">To keep the same time and date, please re-enter it. We are trying to find a solution to it not auto-populating.</p>
