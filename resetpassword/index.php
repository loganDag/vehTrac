...
if (isset($_POST["reset_password"])) {
    ...
    if ($new_db_email == $new_text_input) {
       ...
       <h3>Please go <a href='https://dot.nexgenit.digital/resetPass2.php?code=$reset_pass_code'>Here</a> to finish the reset process.</h3>
       if the link doesn't work, copy and paste this in your browser: https://dot.nexgenit.digital/resetPass2.php?code=$reset_pass_code
       </body>
       </html>
                ";
            $mail->setFrom(
                'DOTno-reply@nexgenit.digital',
                'Dispatch OT System No reply'
            );
